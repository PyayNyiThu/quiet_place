...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <h3 class="logofont">Quiet Place </h3>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            {{-- <a class="nav-link dropdown-toggle" href="{{url('new-booking-list')}}" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                @elseif($booking_count > 9)
                    <span class="badge badge-danger badge-counter">9+</span>
                @else
                    <span class="badge badge-danger badge-counter">{{ $booking_count }}</span>
                @endif
            </a>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                {{-- <h4 class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->user()->name}}</h4>
                <hspan class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->user()->phone}}</hspan> --}}
                {{-- <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"> --}}
                <img width="42" class="rounded-circle"
                    src="https://eu.ui-avatars.com/api/?name={{ auth()->user()->name }}" alt="">
            </a>
